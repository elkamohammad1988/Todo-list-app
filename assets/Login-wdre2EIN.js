import{n as e,s as t,t as n}from"./jsx-runtime-C7M7YA1l.js";import{n as r,s as i}from"./chunk-QFMPRPBF-DmyzOyiA.js";import{_ as a,t as o}from"./firebase-CPlfYfp7.js";import{a as s,i as c,n as l,r as u}from"./fa-Bx0z-9-B.js";var d=t(e(),1),f=n();function p(){let e=i(),[t,n]=(0,d.useState)(``),[p,m]=(0,d.useState)(``),[h,g]=(0,d.useState)(!1),[_,v]=(0,d.useState)(!1),[y,b]=(0,d.useState)(!1),[x,S]=(0,d.useState)(``);async function C(n){n.preventDefault(),S(``),b(!0);try{await a(o,t,p),_&&localStorage.setItem(`remember`,`true`),e(`/dashboard`)}catch{S(`Invalid email or password`)}finally{b(!1)}}return(0,f.jsx)(`div`,{className:`\r
